...
{
    [AddComponentMenu("Layout/Liniear Layout Group", 200)]
    public class LiniearLayout : LayoutGroup
    {
        ...
        [SerializeField] public bool verticle;

        protected LiniearLayout() { }

        public override void CalculateLayoutInputHorizontal()
        {
            base.CalculateLayoutInputHorizontal();
            CalcAlongAxis(0, verticle);
        }

        public override void CalculateLayoutInputVertical()
        {
            CalcAlongAxis(1, verticle);
        }

        public override void SetLayoutHorizontal()
        {
            SetChildrenAlongAxis(0, verticle);
        }

        public override void SetLayoutVertical()
        {
            SetChildrenAlongAxis(1, verticle);
        }
